          ...
          refreshCallback = {
            success: function(refreshedUser) {
              if (_this._callbacks != null) {
                return _this._callbacks.success(refreshedUser, _this._network);
              }
            },
            failure: function(theUser, error) {
              if (_this._callbacks != null) {
                return _this._callbacks.failure(theUser, _this._network, error);
              }
            }
          };
...
KiiXHRWrapper = (function() {
  ...
  KiiXHRWrapper.prototype.setKiiHeaders = function() {
    this.xhr.setRequestHeader("x-kii-appid", root.Kii.getAppID());
    this.xhr.setRequestHeader("x-kii-appkey", root.Kii.getAppKey());
  ...
  KiiXHRWrapper.prototype.setCurrentUserToken = function() {
    var token, _ref;
    token = (_ref = root.KiiUser.getCurrentUser()) != null ? _ref.getAccessToken() : void 0;
    if (token != null) {
